...
- **Graph Neighborhood Unidirectional**: `explore` only returns outgoing relationships (where the entity is the source). It should ideally return both incoming and outgoing edges.

...
- `memory_insert` successfully extracts entities and relationships using the configured LLM (NuExtract via Ollama).
- `memory_search` provides hybrid results combining vector similarity and graph context.
